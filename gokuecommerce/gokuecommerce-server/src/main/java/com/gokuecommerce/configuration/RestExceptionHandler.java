package com.gokuecommerce.configuration;
...
public class RestExceptionHandler{
    ...
    @ExceptionHandler(value = {LoginRequestException.class})
    protected ResponseEntity<Object> loginInvalidResquestException(LoginRequestException errorMessage, WebRequest request){
